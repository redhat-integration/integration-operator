...
# redhat.com/integration-operator-bundle:$VERSION and redhat.com/integration-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/rh_integration/rhi-operator
...
CATALOG_BASE_IMG := registry.redhat.io/redhat/redhat-operator-index:v4.8
...
.PHONY: update-catalog-sources
update-catalog-sources:
	kubectl apply -f config/olm/catalog-source.yaml

.PHONY: rollback-catalog-sources
