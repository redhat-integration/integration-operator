...
func (in *InstallationStatus) DeepCopyInto(out *InstallationStatus) {
	*out = *in
	if in.StatusMap != nil {
		...
		*out = make(map[string]StatusMapValue, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatusMapValue) DeepCopyInto(out *StatusMapValue) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatusMapValue.
func (in *StatusMapValue) DeepCopy() *StatusMapValue {
	if in == nil {
		return nil
	}
	out := new(StatusMapValue)
	in.DeepCopyInto(out)
	return out
}
