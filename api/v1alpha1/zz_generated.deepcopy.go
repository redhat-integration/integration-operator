...
func (in *AMQStreamsInstallationPlan) DeepCopyInto(out *AMQStreamsInstallationPlan) {
	*out = *in
	out.BaseInstallationPlan = in.BaseInstallationPlan
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BaseInstallationPlan) DeepCopyInto(out *BaseInstallationPlan) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BaseInstallationPlan.
func (in *BaseInstallationPlan) DeepCopy() *BaseInstallationPlan {
	if in == nil {
		return nil
	}
	out := new(BaseInstallationPlan)
	in.DeepCopyInto(out)
	return out
}
